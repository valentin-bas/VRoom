...
#ifdef LIBVRGB_EXPORT
#define LIBVRGB_API __declspec(dllexport)
#else
#define LIBVRGB_API __declspec(dllimport)
#endif

#define SAFE_DELETE(ptr) if (ptr != nullptr) delete ptr; ptr = nullptr;
#define SAFE_DELETE_ARRQY(ptr) if (ptr != nullptr) delete[] ptr; ptr = nullptr;

#define CHECK_ALLOC(ptr) if (ptr == nullptr) return false;
